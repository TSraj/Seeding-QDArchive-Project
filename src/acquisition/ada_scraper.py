import time
import requests
from .config import ADA_API_BASE, RATE_LIMIT_DELAY, MAX_PAGES, RESULTS_PER_PAGE, TARGET_EXTENSIONS, RAW_DIR
...
def search_ada(extension: str, max_pages: int = MAX_PAGES):
    ...
    for page in range(1, max_pages + 1):
        ...
        try:
            data = api_get(f"{ADA_API_BASE}/search", params)
