import time
import requests
from .config import HEIDATA_API_BASE, RATE_LIMIT_DELAY, MAX_PAGES, RESULTS_PER_PAGE, TARGET_EXTENSIONS, RAW_DIR
        ...
        for file_item in files:
            ...
            if total_dl > 0:
                ...
                mark_downloaded(
                    ...
                    title=dataset_title,  # Log under dataset title
                    doi=doi,
                    folder_name=folder_name,
                    matched_extensions=list(actual_matched_extensions), # Record the actual extensions found
